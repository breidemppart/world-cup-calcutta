      ...
      <div className="px-6">
        <div className="flex gap-1 bg-gray-900 border border-gray-800 rounded-xl p-1 w-fit mb-4">
          {(['teams', 'bids', 'payouts'] as const).map(t => (
            ...
            >
              {t === 'teams' ? '⚽ Teams' : t === 'bids' ? '📋 Bids' : '💰 Payouts'}
            </button>
          ))}
        </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-800">
                  {bids
                    .filter(b => !filterTeam || b.team_name.toLowerCase().includes(filterTeam.toLowerCase()) || b.bidder_name.toLowerCase().includes(filterTeam.toLowerCase()))
                    .map(bid => (
